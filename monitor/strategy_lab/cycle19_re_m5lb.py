"""cycle19_re_m5lb.py — re-sweep M5_LB at new locked params (cd=15)."""
...
DAILY_DD_STOP = 75.0; CHECK_EVERY = 20
MAX_HOLD_SEC = 1800
...
best = (-99999, None)
for lb in [8, 10, 14, 20, 25, 30, 40, 50]:
...
print(f"\n=== CYCLE 19 BEST: m5_lb={best[1]} → ${best[0]*10:+.0f} ===", flush=True)

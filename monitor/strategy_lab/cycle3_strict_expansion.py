"""cycle3_strict_expansion.py — overnight cycle 3.
Sweep rng60_norm and rng60 thresholds. Maybe stricter expansion filters chop better.
"""
...
best = (-99999, None)
for rng_n in [1.2, 1.5, 1.8, 2.0, 2.5, 3.0]:
...
print(f"\n=== CYCLE 3 BEST: rng_n={best[1][0]} rng={best[1][1]} → ${best[0]*10:+.0f} ===", flush=True)

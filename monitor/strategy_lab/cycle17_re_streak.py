"""cycle17_re_streak.py — re-sweep loss-streak with all new locked params."""
...
configs = [(0, 0)]
for n in [2, 3, 4, 5]:
    for p in [60, 180, 300, 600, 900, 1200, 1800]:
        configs.append((n, p))
for cfg in configs:
    n, p = cfg
...
print(f"\n=== CYCLE 17 BEST: N={best[1][0]} pause={best[1][1]}s → ${best[0]*10:+.0f} ===", flush=True)

//+------------------------------------------------------------------+
//| NsndF11.mq5 — THE REAL METHOD, judged on Zee's own day            |
//|                                                                  |
//| 2026-08-10. Tonight we tuned a UHV-BREAKOUT engine (S1Trader) all |
//| the way to its limits against 2026-02-11 — Zee's real +EUR835 day,|
//| 69 trades, 94% WR — and could not get past -$213:                 |
//|     four exit styles, exhaustively   -> best -$213.20             |
//|     filters on / off / both off      -> best -$213.20             |
//| Nothing tunable reached his day, because his day was not traded   |
//| with UHV breakouts. His own note, written weeks ago, says so:     |
//|   "Zee's method = VSA No Supply / No Demand. He trades NS/ND      |
//|    breaks, not UHV breakouts."                                    |
//| So this is the honest test we should have run first: does the     |
//| NS/ND detector find what he found, on the tape he found it on?    |
//|                                                                  |
//| Note its stop: InpSLBufferPts 0.10 — Zee's average Feb-11 loss    |
//| was 0.13pt. The UHV engine risked 9.82pt. This engine was already |
//| built to his shape.                                               |
//| magic 88097 = tester only, never confusable with a live fill.     |
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+

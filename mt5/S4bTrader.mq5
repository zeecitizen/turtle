//+------------------------------------------------------------------+
//| S4bTrader.mq5 — S4b v2.00: ATR Trailing Exit (walk-forward)     |
//|                                                                  |
//| Same entry as S4b v1.01 (UHV breakout + HH/HL + ER≥0.15 +       |
//| UHV range≥1.0), but EXITS via ATR trailing stop instead of       |
//| fixed TP/SL.                                                     |
//|                                                                  |
//| VALIDATION (backtest_pdf_recommendations.py, 13 real-tick days): |
//|   ATR SL=2x, trail=2x, BE@1x @0.10:                             |
//|     ALL +$1,491 / OOS +$1,362 — WALK-FORWARD POSITIVE ✓          |
//|     WR: 37.2% but avg_loss=$23.6 vs $58 (2.5x smaller losses).  |
//|   Mathematically robust: both train & test halves positive.       |
//|                                                                  |
//| Magic 88008 (distinct from S4=88007 / S3=88003 / S1=88004 /      |
//| NSND=88006).                                                     |
//+------------------------------------------------------------------+
#property copyright "Zee + Antigravity — S4b UHV Breakout (ATR trailing exit)"
...
input double InpUHVRangeMin     = 1.0;  // UHV candle range minimum (pts). 0=off.

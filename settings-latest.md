...
## Changes vs previous snapshot (2026-04-02)
| Setting | Old | New |
|---|---|---|
| My Starting Capital ($) | 866 | **865** |
| Must breakout candle have lower volume | true | **false** |
| Open trade at | Candle Close | **Instant at Breakout** |
| Pre-breakout offset ($) | 0 | **6** |
| Risk: % of capital per trade | 4 | **1** |
| Take Profit: R:R Ratio | 7 | **9** |
| Take Profit: Fixed $ target | 1.1 | **0.1** |
| Alert Gate ($) | -0.05 | **0** |
| IOE TP Guard spread multiplier | 1 | **0** |
| No-Trade Window 19:00–21:00 UTC | true | **false** |
| Wick trigger | false | **true** |
...
| Emergency MAE stop: max loss $ (0=off) | 40 |
...
| Alert Gate ($) | **0** |
| IOE TP Guard spread multiplier | **0** |

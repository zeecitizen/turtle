...
class Cockpit:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🪙 BTC Cockpit — the Bitcoin ghost")
    ...
    def refresh_app(self):
        ...
        try:
            ...
            subprocess.Popen([py, "-u", str(root / "BTCUSD" / "btc_matcher.py")],
    ...
    ARMED_F = Path(r"C:/Users/zeesh/AppData/Roaming/MetaQuotes/Terminal/Common/Files/btc_armed.json")
    WATCH_F = Path(r"C:/Users/zeesh/AppData/Roaming/MetaQuotes/Terminal/Common/Files/btc_watch.json")
    ...
    def _ea_tail(self):
        ...
        try:
            ...
            return [l for l in txt.splitlines()[-400:] if "BTCCase" in l]
        except Exception:
            return []
    ...
    def stage_now(self):
        ...
        try:
            rows = [r for r in self.FILLS_F.read_text(errors="ignore").splitlines()
                    if r.strip() and "BTC" in r.split(",")[3].upper()]
